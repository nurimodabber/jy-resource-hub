...
export const UI_TRANSLATIONS: Record<Language, Record<string, string>> = {
  de: {
    ...
    allBooks: 'Alle Bücher & Texte',
    filterByBook: 'Nach Buch filtern',
    quotesFound: 'Zitate gefunden',
    quoteFound: 'Zitat gefunden',
    filterBookPrompt: 'Buch:',
    chooseAnotherQuote: 'Zitat auswählen',
  ...
  en: {
    ...
    allBooks: 'All Books & Texts',
    filterByBook: 'Filter by Book',
    quotesFound: 'Quotes found',
    quoteFound: 'Quote found',
    filterBookPrompt: 'Book:',
    chooseAnotherQuote: 'Select quote',
